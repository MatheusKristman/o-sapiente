...
export function EmailOfferNotification(
    title: string,
    message: string,
    buttonText: string,
) {
            ...
            <Tailwind>
                <Body style={main}>
                    <Container style={container}>
                        ...
                        <Text className="text-base">
                            Queremos informar que você recebeu uma{" "}
                            <strong>proposta </strong>para a solicitação de aula
                            que você criou em nossa plataforma,{" "}
                            <strong>O Sapiente</strong>. Estamos felizes em ver
                            o interesse dos professores em contribuir para o seu
                            aprendizado.
                        </Text>
                        ...
                        <Section style={{ marginBottom: "35px" }}>
                            ...
                            <Row>
                                <strong>Disciplina: </strong>Teste
                            </Row>
                            <Row>
                                <strong>Mensagem: </strong>Mensagem teste
                            </Row>
                        </Section>
