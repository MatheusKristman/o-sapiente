            ...
            <Tailwind>
                <Body style={main}>
                    <Container style={container}>
                        ...
                        <Text className="text-base">
                            Gostaríamos de informar que o{" "}
                            <strong>[Nome do Aluno/Professor]</strong> indicou
                            que deseja <strong>finalizar </strong>a aula que
                            vocês têm juntos em nossa plataforma,{" "}
                            <strong>O Sapiente</strong>.
                        </Text>

                        <Text className="text-base">
                            Se você também concorda em finalizá-la, por favor,
                            clique no botão abaixo para confirmar. Se preferir
