...
const DashboardPage = () => {
  return (
    <div className="flex-1 w-full px-6 pt-9 mx-auto flex flex-col gap-9 md:flex-row md:px-16 lg:container">
      <div className="w-full flex flex-col-reverse gap-9 md:flex-col xl:w-6/12">
          ...
          <div className="w-full h-56 scrollbar scrollbar-thumb-slate-100">
            <div className="w-full rounded-lg bg-white p-5">
              <div className="flex flex-col lg:flex-row lg:gap-6">
                ...
                <div className="flex items-center justify-center p-2.5 text-green-primary text-lg font-semibold lg:p-1">
                  <span>John Doe</span>
          ...
          <div className="w-full h-56 scrollbar scrollbar-thumb-slate-100">
            <div className="w-full rounded-lg bg-green-primary p-5">
              <div className="flex flex-col lg:flex-row lg:gap-6">
                ...
                <div className="flex items-center justify-center p-2.5 text-white text-lg font-semibold lg:p-1">
                  <span>John Doe</span>
