    ...
    <div className="w-full px-6 pt-12 mx-auto md:px-16 lg:container lg:pt-10 lg:pb-12">
      <main className="flex flex-col gap-3.5">
        ...
        <p className="text-base md:text-lg mt-2.5 text-start text-gray-800">
          A sua privacidade é importante para nós. É política do O Sapiente
        ...
        <h2 className="text-2xl mt-5 font-bold text-start text-gray-800">
          Compromisso do Usuário
        </h2>
        <p className=" text-base md:text-lg text-gray-800">
          O usuário se compromete a fazer uso adequado dos conteúdos e da
          informação que o O Sapiente oferece no site e com caráter enunciativo,
          mas não limitativo:
        </p>
        <ul className="text-base md:text-lg px-6 text-gray-800 list-disc ">
          <li className="mb-3.5">
          ...
          <li className="mb-3.5">
            ...
            (softwares) do O Sapiente, de seus fornecedores ou terceiros, para
        ...
        <p className=" text-base md:text-lg mb-[50px] text-gray-800">
          Esta política é efetiva a partir de 22 August 2023 17:30
        </p>
      </main>
    </div>
  );
