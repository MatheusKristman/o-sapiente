...
import {
  leftCardAnimation,
  rightCardAnimation,
} from "@/constants/framer-animations/course-ad";
...
export function AdCard({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "w-full px-9 py-10 bg-white rounded-2xl shadow-lg flex flex-col gap-10",
        {
    ...
    >
      <div className="w-full flex flex-col items-center gap-6">
        <h3 className="text-2xl text-gray-primary font-semibold text-center">
          {title}
        </h3>
        ...
        <div className="w-full flex flex-col items-center gap-6">
          ...
          <div className="w-full flex flex-col gap-6 items-center">
            <Button asChild className="w-full">
              <Link href={`/pagamento-do-curso/${courseId}`}>
                {courseAdInfo.paymentButton}
              </Link>
            </Button>
            ...
            >
              <a
                href={`https://wa.me/557996475310?text=Ol%C3%A1,%20gostaria%20de%20tirar%20d%C3%BAvidas%20sobre%20o%20curso%20${courseLink}`}
      ...
      <div className="w-full flex flex-col gap-6 items-center">
        {themes ? (
          <div className="w-full flex flex-col gap-5 items-center">
            <h3 className="text-center text-gray-primary font-semibold text-xl">
              {courseAdInfo.themesTitle}
            </h3>
        ...
        <div className="border-2 border-green-primary rounded-2xl bg-transparent p-5 flex flex-col items-center gap-5">
          <h3 className="text-lg font-semibold text-green-primary text-center">
            {courseAdInfo.benefitsTitle}
          </h3>
