                                        ...
                                        >
                                            <div className="flex flex-col gap-1">
                                                <input
                                                    ...
                                                    type="text"
                                                    placeholder={
                                                        professorLoginInfo.email
                                                    }
                                                    name="email"
                                                    autoComplete="off"
                                                    autoCorrect="off"
                                                    disabled={isSubmitting}
                                                    className={`px-4 py-2 w-full h-11 rounded-lg bg-[#EBEFF1] outline-none text-[#2C383F] placeholder:text-[#9DA5AA] focus:bg-[#DAE2E7] transition-colors disabled:brightness-75 disabled:cursor-not-allowed disabled:hover:brightness-75 ${errors.email &&
                                            ...
                                            <div className="flex flex-col gap-1">
                                                <input
                                                    ...
                                                    type="password"
                                                    placeholder={
                                                        professorLoginInfo.password
                                                    }
                                                    name="password"
                                                    autoComplete="off"
                                                    autoCorrect="off"
                                                    disabled={isSubmitting}
                                                    className={`px-4 py-2 w-full h-11 rounded-lg bg-[#EBEFF1] outline-none text-[#2C383F] placeholder:text-[#9DA5AA] focus:bg-[#DAE2E7] transition-colors disabled:brightness-75 disabled:cursor-not-allowed disabled:hover:brightness-75 ${errors.password &&
                                                        "border-[#FF7373] border-2 border-solid"
                                                        }`}
                                                />
