  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="mx-auto -mt-24 w-full px-6 md:px-16 lg:container lg:mt-0"
      >
        <motion.div
        ...
        <motion.div
          ...
          className="bg-bannerMobile bg-no-repeat bg-cover bg-bottom rounded-2xl max-w-4xl mx-auto relative sm:bg-bannerTablet sm:bg-right lg:bg-bannerDesktop"
        >
          <div className="px-9 pt-7 pb-80 rounded-2xl bg-gradient-to-b from-[#37474F] from-50% sm:pb-7 sm:bg-gradient-to-r z-[99]">
