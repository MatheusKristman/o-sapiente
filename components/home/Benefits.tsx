...
const Benefits = () => {
  ...
  return (
    <section className="w-full min-h-[1216px] mx-auto px-6 mt-12 relative z-[99] sm:min-h-[1028px] md:px-16 lg:container xl:min-h-fit xl:flex xl:items-center xl:mt-24 xl:h-[600px]">
