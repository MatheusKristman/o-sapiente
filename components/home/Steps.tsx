...
import {
  stepsTitleAnimation,
  stepsCardAnimation,
} from "@/constants/framer-animations/steps";
        ...
        >
          {stepsInfo.cards.map((card) => (
            <motion.div
              ...
              className="w-full px-6 py-9 bg-[#2C383F] rounded-2xl border-[#2C383F] group hover:border-green-primary border-solid border-2 transition-colors transition-shadow shadow-md shadow-[rgba(0,0,0,0.25)] hover:shadow-lg"
            >
