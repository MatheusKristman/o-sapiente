...
const ProfilePhotoStep: React.FC<ProfilePhotoStepProps> = ({
  ...
  function handleNextButton() {
    if (actualStep === 1) {
      setSteps((actual: number) => actual + 1);
    }
  ...
  return (
    <div className="w-full mx-auto px-6 md:px-16 lg:container pt-12 flex flex-col gap-9 md:flex-row md:justify-between md:pt-24 md:gap-24">
