  ...
  return (
    <button
      ...
      className={cn(
        ...
        primaryMobile && "bg-white border-white text-green-primary disabled:brightness-75 disabled:hover:brightness-75",
        secondaryMobile && "bg-transparent border-white text-white disabled:bg-white/10 disabled:hover:bg-white/10",
