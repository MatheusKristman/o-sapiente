                        ...
                        ? menuItems.map((item, index) => (
                            <li
                                ...
                                className={cn(
                                    ...
                                    pathname.includes(item.professorHref) && pathname.includes(item.pageHref) && item.professorHref !== ""
                                        ? linkActiveClass
                                        : linkInactiveClass,
                                )}>
                    ...
                    {pathname?.includes("aluno")
                        ? menuItems.map((item, index) => (
                            <li
                                ...
                                className={cn(
                                    "p-4 flex items-center gap-2 cursor-pointer transition-colors hover:bg-white hover:text-green-primary",
                                    pathname.includes(item.studentHref) && pathname.includes(item.pageHref) && item.studentHref !== ""
                                        ? linkActiveClass
                                        : linkInactiveClass,
                                )}>
                                <item.icon className="h-fit w-fit" />
