...
export function PaymentButtons({ isSubmitting }: Props) {
  ...
  return (
    <div className="w-full flex flex-col gap-4 mb-12">
      {pathname !== "/pagamento-do-plano" && !pathname?.includes("/pagamento-da-aula") && (
      ...
      <div className="w-full flex items-center justify-between gap-4">
        <Button disabled={isSubmitting} type="button" variant="gray" onClick={handleBack} className="w-1/2">
          {info.backButton}
        </Button>

        <Button disabled={isSubmitting} type="submit" className="w-1/2 flex items-center gap-2">
